...
import {
  BookMarked, Plus, Trash2, Check, X,
      ...
      >
        ...
        <div className="px-3 py-3 border-b flex items-center justify-between" style={{ borderColor: "var(--border)" }}>
          ...
          <div className="flex items-center gap-1">
            <button onClick={refresh} title="Refresh" className="p-1 rounded hover:opacity-60 transition-opacity">
              <RefreshCw className="w-3.5 h-3.5" style={{ color: "var(--text-2)" }} />
            </button>
            <button onClick={startNew} title="New preset" className="p-1 rounded transition-all" style={{ color: gold }}>
        ...
        <div className="flex-1 overflow-y-auto py-1">
          {loading && (
            <p className="text-[10px] font-mono px-4 py-3" style={{ color: "var(--text-2)" }}>Loading...</p>
          )}
