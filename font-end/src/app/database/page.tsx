...
export default function DatabasePage() {
  ...
  const inputStyle = {
    backgroundColor: "var(--surface-2)", borderColor: "var(--border)", color: "var(--text-1)",
  };
                          ...
                          <tr style={{
                            ...
                            <td className={cellBase}>
                              <div className="flex items-center gap-0.5">
                                {editingId === s.id ? (
                                  <button onClick={() => commitEdit(s.id)}
                                    className="p-1.5 rounded hover:opacity-70" title="Save">
                                    <Check className="w-3.5 h-3.5" style={{ color: blue }} />
                                  </button>
                                ) : (
                                  <button onClick={() => startEdit(s)}
                                    className="p-1.5 rounded hover:opacity-70" title="Rename">
                                    <Edit2 className="w-3.5 h-3.5" style={{ color: "var(--text-2)" }} />
                                  </button>
                                )}
                                <button onClick={() => setConfirmDelete(s.id)}
                                  className="p-1.5 rounded hover:opacity-70" title="Delete">
